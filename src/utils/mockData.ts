...
export const accounts = [
  ...
  ...Array(13).fill(null).map((_, index) => ({
    id: `gmail-${index + 1}`,
    title: `Gmail账户 ${['基础版', '高级版', 'Premium版'][index % 3]}`,
    price: [15.99, 25.99, 35.99][index % 3],
    originalPrice: [19.99, 29.99, 39.99][index % 3],
    image: '/images/gmail.png',
    category: 'gmail',
  ...
  ...Array(13).fill(null).map((_, index) => ({
    id: `outlook-${index + 1}`,
    title: `Outlook账户 ${['基础版', '高级版', 'Premium版'][index % 3]}`,
    price: [14.99, 24.99, 34.99][index % 3],
    originalPrice: [18.99, 28.99, 38.99][index % 3],
    image: '/images/outlook.png',
    category: 'outlook',
    ...
    features: [
      ...
      '已完成手机验证',
      '支持安全登录',
      ['5GB存储空间', '15GB存储空间', '50GB存储空间'][index % 3],
    ],
    deliveryMethod: '自动发货',
    verificationMethod: '已验证',
  })),
  ...
  ...Array(13).fill(null).map((_, index) => ({
    id: `yahoo-${index + 1}`,
    title: `Yahoo账户 ${['基础版', '高级版', 'Premium版'][index % 3]}`,
    price: [14.99, 24.99, 34.99][index % 3],
    originalPrice: [18.99, 28.99, 38.99][index % 3],
    image: '/images/yahoo.png',
    category: 'yahoo',
    ...
    features: [
      ...
      '支持安全登录',
      '可修改密码',
      ['1GB存储空间', '5GB存储空间', '25GB存储空间'][index % 3],
    ],
    deliveryMethod: '自动发货',
    verificationMethod: '已验证',
  })),
  ...
  ...Array(13).fill(null).map((_, index) => ({
    id: `gmx-${index + 1}`,
    title: `GMX账户 ${['基础版', '高级版', 'Premium版'][index % 3]}`,
    price: [13.99, 23.99, 33.99][index % 3],
    originalPrice: [17.99, 27.99, 37.99][index % 3],
    image: '/images/gmx.png',
    category: 'gmx',
    categoryName: 'GMX邮箱',
    stock: 20,
  ...
  ...Array(13).fill(null).map((_, index) => ({
    id: `aol-${index + 1}`,
    title: `AOL账户 ${['基础版', '高级版', 'Premium版'][index % 3]}`,
  ...
  ...Array(13).fill(null).map((_, index) => ({
    ...
    title: `ProtonMail账户 ${['基础版', '高级版', 'Premium版'][index % 3]}`,
    price: [18.99, 28.99, 38.99][index % 3],
    originalPrice: [22.99, 32.99, 42.99][index % 3],
    image: '/images/protonmail.png',
    category: 'protonmail',
    ...
    features: [
      ...
      '支持安全登录',
      '可修改密码',
      ['500MB存储空间', '2GB存储空间', '10GB存储空间'][index % 3],
    ],
    deliveryMethod: '自动发货',
    verificationMethod: '已验证',
  })),
  ...
  ...Array(13).fill(null).map((_, index) => ({
    id: `mail-${index + 1}`,
    title: `Mail.com账户 ${['基础版', '高级版', 'Premium版'][index % 3]}`,
    price: [13.99, 23.99, 33.99][index % 3],
    originalPrice: [17.99, 27.99, 37.99][index % 3],
    image: '/images/mail.png',
    category: 'mail',
  ...
  ...Array(13).fill(null).map((_, index) => ({
    ...
    originalPrice: [20.99, 30.99, 40.99][index % 3],
    image: '/images/german.png',
    category: 'german',
    categoryName: '德国DE邮箱',
    stock: 20,
  ...
  ...Array(13).fill(null).map((_, index) => ({
    ...
    title: `Instagram账户 ${['基础版', '高级版', 'Premium版'][index % 3]}`,
    price: [16.99, 26.99, 36.99][index % 3],
    originalPrice: [20.99, 30.99, 40.99][index % 3],
    image: '/images/instagram.png',
    category: 'instagram',
  ...
  ...Array(13).fill(null).map((_, index) => ({
    id: `twitter-${index + 1}`,
    title: `Twitter账户 ${['基础版', '高级版', 'Premium版'][index % 3]}`,
    price: [15.99, 25.99, 35.99][index % 3],
    originalPrice: [19.99, 29.99, 39.99][index % 3],
    image: '/images/twitter.png',
    category: 'twitter',
  ...
  ...Array(13).fill(null).map((_, index) => ({
    id: `facebook-${index + 1}`,
    title: `Facebook账户 ${['基础版', '高级版', 'Premium版'][index % 3]}`,
    price: [17.99, 27.99, 37.99][index % 3],
    originalPrice: [21.99, 31.99, 41.99][index % 3],
    image: '/images/facebook.png',
    category: 'facebook',
  ...
  ...Array(13).fill(null).map((_, index) => ({
    id: `discord-${index + 1}`,
    title: `Discord账户 ${['基础版', '高级版', 'Premium版'][index % 3]}`,
    price: [13.99, 23.99, 33.99][index % 3],
    originalPrice: [17.99, 27.99, 37.99][index % 3],
    image: '/images/discord.png',
    category: 'discord',
  ...
  ...Array(13).fill(null).map((_, index) => ({
    id: `chatgpt-${index + 1}`,
    title: `ChatGPT账户 ${['基础版', '高级版', 'Premium版'][index % 3]}`,
    price: [19.99, 29.99, 39.99][index % 3],
    originalPrice: [23.99, 33.99, 43.99][index % 3],
    image: '/images/chatgpt.png',
    category: 'chatgpt',
  ...
  ...Array(13).fill(null).map((_, index) => ({
    id: `tiktok-${index + 1}`,
    title: `TikTok账户 ${['基础版', '高级版', 'Premium版'][index % 3]}`,
    price: [16.99, 26.99, 36.99][index % 3],
    originalPrice: [20.99, 30.99, 40.99][index % 3],
    image: '/images/tiktok.png',
    category: 'tiktok',
